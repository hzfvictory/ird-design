module.exports = (function (e) {
  ...
  function (e, t, o) {
    ...
    var r = function () {
      ...
      return o(
        ...
        [
          ...
          e._t("default"),
          e.$slots.footer
            ? o("template", { slot: "footer" }, [e._t("footer")], 2)
            : o(
                "span",
    ...
    var a = {
        name: "IrdModal",
        components: { [n.Dialog.name]: n.Dialog, [n.Button.name]: n.Button },
        props: l(
          l({}, n.Dialog.props),
          {},
          {
    ...
    c.options.__file = "packages/ird-modal/src/index.vue";
    var f = c.exports;
