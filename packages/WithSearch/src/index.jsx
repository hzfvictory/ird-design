...
import IrdSelect from "../../IrdSelect";
...
export default {
  ...
  methods: {
    ...
    typeSearchBtn() {
      ...
      const searchDom = <el-button
        type="primary"
        size={this.irdSize}
        icon="el-icon-search"
        onClick={this.handleSearch}>查询</el-button>;
      const resetDom = <el-button icon="el-icon-refresh" size={this.irdSize} onClick={this.handleReset}>重置</el-button>;
      return (
        <div>
          {onSearch && searchDom}
          {onReset && resetDom}
